...
text("-Flecha hacia arriba para cepillarse los dientes",20,55);
text("-Flecha hacia abajo para ejercitarse",20,70);
text("-Flecha Izquierda para bañarse",20,85);
text("-Flecha Derecha para comer",20,100);
text("-Presiona M para flotar",20,115);
